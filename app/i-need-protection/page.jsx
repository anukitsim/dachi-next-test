...
const Protection = () => {
  return (
    <div class="grid grid-cols-6 grid-rows-1">
      <div className="row-start-1 col-start-1 col-span-6 ml-[-170px] mt-[-60px] min-[300px]:ml-[100px] min-[300px]:mt-[100px] ">
        <Image
      ...
      <div className="row-start-1 col-start-5 col-span-2 self-start mt-[150px] mr-5 min-[1900px]:mt-[220px] min-[1800px]:mt-[220px] min-[1700px]:mt-[200px] min-[1600px]:mt-[200px] min-[300px]:row-start-2 min-[300px]:col-start-2 min-[300px]:col-span-5 min-[300px]:mt-[10px]">
      <Image
      ...
      <div className="row-start-1  col-start-5 self-center col-span-2 min-[1900px]:mt-[-100px] min-[1900px]:mr-5  min-[1800px]:mt-[-100px] min-[1800px]:ml-20 min-[1700px]:ml-12 min-[1600px]:ml-12 min-[300px]:row-start-3 min-[300px]:col-start-2 min-[300px]:col-span-5">
